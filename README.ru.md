...
|---|---|---|
| Мост Windows 10/11 | `0.2.0` | ✅ Выпущен (win-device, 38 инструмента, streamable-http) |
| Мост macOS 12+ | `0.3.0` | ✅ Выпущен (mac-device, launchd, 39 инструмента, процесс выдачи GUI-разрешений) |
