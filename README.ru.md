...
|---|---|---|
| Мост Windows 10/11 | `0.2.0` | ✅ Выпущен (win-device, 38 инструментов, streamable-http) |
| Мост macOS 12+ | `0.3.0` | ✅ Выпущен (mac-device, launchd, 39 инструментов, процесс выдачи GUI-разрешений) |
