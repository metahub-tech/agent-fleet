...
Подключите **реальные устройства** — ПК на Windows, Mac, Android-телефоны, iPhone — в инструментальную цепочку вашего LLM-агента, чтобы он управлял ими как локальными командами: скриншоты, нажатие кнопок, запуск тестов, чтение логов, отладка GUI.
...
| Мост macOS 12+ | `0.3.0` | ✅ Выпущен (mac-device, launchd, 31 инструмент, поток GUI-разрешений) |
...
| Патчи v0.6.x (интроспекция UI, smoke-тесты, исправления, упрочнение установщика…) | `0.6.1–0.6.15` | ✅ Выпущены — см. [CHANGELOG.md](CHANGELOG.md) |
