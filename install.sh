...
#
# Env-var overrides:
#   AGENT_FLEET_VERSION      default v0.6.12-alpha
...
AGENT_FLEET_VERSION="${AGENT_FLEET_VERSION:-v0.6.12-alpha}"
...
ERROR: agent-fleet's installer is interactive but stdin is not a TTY.
  ...
  Or, since v0.6.12-alpha already cloned the repo for you in a prior attempt:
