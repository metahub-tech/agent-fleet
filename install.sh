...
#
# Env-var overrides:
#   AGENT_FLEET_VERSION      default v0.8.1-alpha
...
AGENT_FLEET_VERSION="${AGENT_FLEET_VERSION:-v0.8.1-alpha}"
...
ERROR: agent-fleet's installer is interactive but stdin is not a TTY.
  ...
  Or, since v0.8.1-alpha already cloned the repo for you in a prior attempt:
