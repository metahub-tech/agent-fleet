...
#
# Env-var overrides:
#   AGENT_FLEET_VERSION      default v0.7.3-alpha
...
AGENT_FLEET_VERSION="${AGENT_FLEET_VERSION:-v0.7.3-alpha}"
...
ERROR: agent-fleet's installer is interactive but stdin is not a TTY.
  ...
  Or, since v0.7.3-alpha already cloned the repo for you in a prior attempt:
