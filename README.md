...
[![Status](https://img.shields.io/badge/status-v0.6.1--alpha-blue.svg)](https://github.com/metahub-tech/agent-fleet/releases/tag/v0.6.1-alpha)
...
>
> ```bash
> uvx --from "git+https://github.com/metahub-tech/agent-fleet@v0.6.1-alpha#subdirectory=cli" agent-fleet setup
> ```
...
| **UI element introspection (Android uiautomator + macOS AX)** | **`0.6.1-alpha`** | ✅ **Released** (mac-device +3 tools, android-device +3 tools；find/tap/click by text/role/resource-id instead of pixel-guessing) |
...
或，如果已经有 uv（v0.6.1-alpha 阶段从 git 拉，未上 PyPI）：
